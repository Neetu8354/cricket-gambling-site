  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO
        ...
        canonical="/"
        keywords="mahadev book, mahadev book id, mahadev book login, mahadev book register, mahadev online book, mahadevbook official, online cricket score, ipl 2026 schedule, ipl 2026 live score, t20 world cup 2026, cricket news today, cricket live updates, fantasy cricket tips, cricket prediction, dream11 prediction, my11circle tips, teen patti game, andar bahar game, rummy online, ludo online, online card games, indian card games, skill gaming india, online gaming platform, real money skill games, 24x7 customer support, upi payments india, instant upi transfer, secure online payments, kyc verified platform, responsible gaming, 18 plus gaming, hindi gaming support, mahadev id whatsapp, mahadev book contact, mahadev book customer care, online entertainment india, premium gaming id, verified gaming account, indian gaming community"
        jsonLd={jsonLd}
      />
      <TickerBar />
      <Header />
      <main>
        ...
        <section className="container py-16 md:py-24" id="blog-preview">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <div className="eyebrow justify-center mb-4">From the Blog</div>
            <h2 className="text-3xl md:text-5xl font-display font-bold leading-tight">
              Expert <span className="text-gradient-gold italic">Betting Guides</span> & Strategy
            </h2>
            ...
            {featured.map(post => (
              <Link key={post.slug} to={`/blog/${post.slug}`}
                ...
                <div className="aspect-video bg-muted overflow-hidden">
                  <img src={post.cover} alt={altFor(post.cover)} title={post.title} loading="lazy" width={600} height={338} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                </div>
                <div className="p-5">
