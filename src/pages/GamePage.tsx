...
const GamePage = () => {
  ...
  const url = `https://mahadevbook14.live/games/${game.slug}`;
  const jsonLd: object[] = [
    {
      ...
      inLanguage: "en-IN",
      isPartOf: { "@type": "WebSite", name: "Mahadev Book", url: "https://mahadevbook14.live/" },
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Games", item: "https://mahadevbook14.live/games" },
