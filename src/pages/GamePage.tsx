...
const GamePage = () => {
  ...
  const url = `https://www.mahadevbook14.live/games/${game.slug}`;
  const jsonLd: object[] = [
    {
      ...
      inLanguage: "en-IN",
      isPartOf: { "@type": "WebSite", name: "Mahadev Book", url: "https://www.mahadevbook14.live/" },
    },
    {
      "@context": "https://schema.org",
      "@type": "Service",
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 2, name: "Games", item: "https://www.mahadevbook14.live/games" },
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-10 md:py-16 max-w-5xl">
        ...
        <header className="mb-10">
          ...
          <div className="flex flex-wrap items-center gap-4 mt-6">
            ...
            <Link to="/contact"
              ...
              <MessageCircle className="w-5 h-5 text-whatsapp" /> Contact Support
            </Link>
          </div>
        </header>

        <div className="aspect-video w-full rounded-2xl overflow-hidden border border-gold/20 mb-10 bg-muted">
          <img src={game.image} alt={game.alt} title={game.h1} className="w-full h-full object-cover" loading="eager" width={1280} height={720} />
        </div>
        ...
        <aside className="mt-12 p-8 rounded-2xl bg-gradient-gold-soft border border-gold/30 text-center">
          ...
          <p className="text-muted-foreground mb-5">Instant ID • UPI deposit ₹100 min • Fast INR withdrawal</p>
          <Link to="/contact"
