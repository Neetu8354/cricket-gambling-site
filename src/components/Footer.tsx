  ...
  <footer className="border-t border-gold/20 bg-gradient-dark mt-12">
    <div className="container py-14 grid md:grid-cols-5 gap-10">
      <div className="md:col-span-2">
        <img src={logo} alt="Get cricket ID online instantly on Mahadev Book India" title="Mahadev Book Logo - India's #1 Online Cricket Betting ID Provider" className="h-14 w-auto mb-4" width={224} height={56} loading="lazy" />
